function [d_out,d_ref_out, x_warp_all] = align_by_DP_using_ref( d, d_ref, align_blocks_in, PLOT_STUFF );
...
for j = 1:length( align_blocks_in )
  [d_ref_out, x_warp_all ] = align_by_DP( d_ref_out,  align_blocks_in{j}  );
  size( x_warp_all);
