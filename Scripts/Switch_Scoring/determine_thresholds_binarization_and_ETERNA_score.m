function [ min_SHAPE, max_SHAPE, threshold_SHAPE, ETERNA_score, d_bin ] = determine_thresholds_binarization_and_ETERNA_score( data, pred, NEW_SETTINGS );
% output d_bin: binarized area_peak data
