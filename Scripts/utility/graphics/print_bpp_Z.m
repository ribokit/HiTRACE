...
%   [scale_factor]       Optional        Provides the scale factor for Z score 
%                                            matrix. Default -5.
%   [filename]           Optional        Provides the filename prefix for output 
%                                            images. Default is blank. Underlines added
%                                            automatically.
