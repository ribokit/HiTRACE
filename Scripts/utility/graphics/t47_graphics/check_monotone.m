...
if array_monotone == [1 1 0 0]; num_flag = -2; str_flag = 'Not monotonic'; end;
if array_monotone == [1 0 0 0]; num_flag = -1; str_flag = 'Strictly monotonic decreasing'; end;
if array_monotone == [0 0 0 0]; num_flag = 0; str_flag = 'Non-strictly monotonic decreasing'; end;
